...
<div class="right">
	...
	<?php
		echo $this->Form->create('Bird',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Group'=>'group','Family'=>'family','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
