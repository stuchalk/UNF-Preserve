...
<div class="right">
	<h2>Add a New Invertebrate</h2>
	<div style="width: 500px;">
	<?php
		echo $this->Form->create('Invert',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Genus'=>'genus','Family'=>'family','Order'=>'order','Species'=>'species','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
