...
<div class="right">
	<h2>Add a New Amphibian/Reptile</h2>
	<div style="width: 500px;">
	<?php
		echo $this->Form->create('Herp',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Genus'=>'genus','Family'=>'family','Order'=>'order','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
