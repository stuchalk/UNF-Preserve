...
<div class="right">
	<h2>Add a New Lichen</h2>
	<div style="width: 500px;">
	<?php
		echo $this->Form->create('Lichen',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Type'=>'type','Species'=>'species','Family'=>'family','Genus'=>'genus','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
        foreach($fields as $key=>$field)
        {
            ...
            if($field=="type") {
                echo $this->Form->input('type',['type'=>'select','options'=>[''=>'Select type...','Crutose'=>'Crustose','Foliose'=>'Foliose','Fruticose'=>'Fruticose'],'label'=>false,'div'=>false]);
            } else if($field=="url") {
                echo $this->Form->input('ns',['type'=>'select','options'=>[''=>'Select website...']+$ns,'label'=>false,'div'=>false]);
