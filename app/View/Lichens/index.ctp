		...
		<div class="row my-1">
			...
			<div class="col-sm-12 col-md-7 col-lg-8 col-xl-9 order-1 order-md-2">
				<div class="row">
					...
					<div class='col-sm-12'>
						<p>Click below or download the <?php echo $this->Html->link('Inventory PDF','/files/pdf/Lichens of the UNF Sawmill Slough Preserve.pdf'); ?></p>
						<div class='list-group responsivediv2'>
							<ul style="padding: 0;">
								<?php
								foreach($data as $pid=>$title) {
									echo '<li class="list-group-item">'.html_entity_decode($this->Html->link($title,'/lichens/view/'.$pid)).'</li>';
								}
								?>
							</ul>
						</div>
