...
<div class="right">
	...
	<?php
		echo $this->Form->create('Fish',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Group'=>'group','Family'=>'family','Genus'=>'genus','Species'=>'species','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
