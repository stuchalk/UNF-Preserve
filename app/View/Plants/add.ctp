...
<div class="right">
	...
	<?php
		echo $this->Form->create('Plant',['action'=>'add']);
		$fields=['Common Name'=>'cname','Scientific Name'=>'sname','Group'=>'group','Family'=>'family','Genus'=>'genus','URL'=>'url','Stock photo'=>'image_url','Comments'=>'comment'];
        foreach($fields as $key=>$field)
        {
            echo "<div style='display: table-row;'>";
            echo "<div style='width: 200px;text-align: right;display: table-cell;'>".$key."</div>";
