...
<div class="right">
	...
	<div id="AddPhotos">
		...
		<?php echo $this->Form->create(Inflector::pluralize($t),['action'=>'add','enctype'=>'multipart/form-data']); ?>
		<?php echo $this->Form->input($t.'.col',['type'=>'hidden','value'=>'unfenvc:30']); // 30 is the preserve collection ?>
